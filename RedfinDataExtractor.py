...
class RedfinDataExtractor:
    ...
    def get_listing_data(self, search_criteria: str, home_types: list, time_on_redfin: str, delete_csv: bool):
        return self.listing_data_extractor.get_data(search_criteria, home_types, time_on_redfin, delete_csv)

    def get_sales_data(self, search_criteria: str, home_types: list, sold_within: str, delete_csv: bool):
        return self.sales_data_extractor.get_data(search_criteria, home_types, sold_within, delete_csv)
